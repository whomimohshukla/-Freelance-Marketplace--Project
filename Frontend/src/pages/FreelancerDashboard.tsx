...
import projectApi, { Project, DashboardStats, FreelancerProfile } from '../api/projectApi';
...
const FreelancerDashboard = () => {
  ...
  const fetchDashboard = async () => {
    try {
      setLoading(true);
      const response = await projectApi.getFreelancerDashboard();
      if (response.success) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400">Track your projects and earnings</p>
        </motion.div>
        ...
        {profile && (
          <motion.div
            ...
            className="bg-gradient-to-r from-code-green/10 to-code-green/5 border border-code-green/20 rounded-xl p-6 mb-8"
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-white">
                    {formatCurrency(profile.hourlyRate || 0)}/hr
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">
                    {profile.availability?.hoursPerWeek || 0} hrs/week
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 bg-code-green/10 rounded-lg">
                <FiDollarSign className="w-6 h-6 text-code-green" />
              </div>
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-2xl font-bold text-white">{stats?.successRate || 0}%</span>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          >
            ...
            <p className="text-3xl font-bold text-white">
              {formatCurrency(stats?.avgProjectValue || 0)}
            </p>
          </motion.div>
