          ...
          {[
            {
              ...
              description: "Robust user authentication system with role-based access control for clients and freelancers."
            },
            {
              icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2",
              title: "Project Management",
              description: "Create, track, and manage projects with milestone tracking and progress monitoring."
            },
            {
              icon: "M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z",
              title: "Proposal System",
              description: "Submit and review detailed proposals with custom requirements and pricing options."
            },
            {
              icon: "M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z",
              title: "Real-time Chat",
              description: "Instant messaging system with file sharing and notification support."
            },
            {
              icon: "M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z",
              title: "Secure Payments",
              description: "Integrated payment system with escrow protection and milestone-based releases."
            },
            {
              icon: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z",
              title: "Advanced Search",
              description: "Powerful search with filters for skills, budget, location, and project categories."
            }
          ].map((feature, index) => (
            <motion.div
              key={index}
          ...
          {[
            ...
            >
              ...
              <div className="relative p-6 rounded-lg border border-code-green/20">
                <div className="text-4xl font-bold text-code-green mb-4">{item.step}</div>
          ...
          {[
            {
              ...
              quote: "SkillBridge made it incredibly easy to find talented developers. The quality of work exceeded our expectations."
            },
            {
              name: "Michael Chen",
              ...
              quote: "As a freelancer, I've found amazing opportunities through SkillBridge. The platform is intuitive and client communication is seamless."
            },
            {
              name: "Emily Davis",
              ...
              quote: "The proposal system and project management tools helped us scale our development team efficiently."
            }
