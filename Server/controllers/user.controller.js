...
const { getLocationInfo, isSuspiciousLocation, formatLocation } = require("../utils/location");
...
const login = async (req, res) => {
  try {
    ...
    const isSuspicious = isSuspiciousLocation(user.location?.current, locationInfo);
