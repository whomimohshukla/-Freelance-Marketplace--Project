...
// @access  Public
router.get('/profile/:userId', validateObjectId('userId'), clientController.getProfile);
...
// @route   DELETE /api/clients/team/:memberId
// @desc    Remove team member
// @access  Private
router.delete('/team/:memberId', [auth, validateObjectId('memberId')], clientController.removeTeamMember);
...
// @route   DELETE /api/clients/payment-methods/:methodId
// @desc    Remove payment method
// @access  Private
router.delete('/payment-methods/:methodId', [auth, validateObjectId('methodId')], clientController.removePaymentMethod);
